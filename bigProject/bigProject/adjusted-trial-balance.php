...
<body>
    ...
    <div class="container">
        <h1 class="customize">Adjusted Trial Balanced</h1>
        <div class="row">
            <div class="col-md-12">
                <center>
                    <table id="tb1" style="width:80%">
                         <tr>
                            <th class="b" colspan="3"><center>The cake shop <br>Adjusted Trial balanced <br>
                        ...
                        <tr>
                            <th class="a"><center>Account titles</th>
                            <th class="a">Debit</th>
